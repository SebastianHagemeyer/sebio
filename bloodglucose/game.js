...
function simulateSliderInput() { // 40 is ideal
...
setInterval(function () {
    ...
    if (!gameEnded) {
        ...
        if ((currentTime.hours === 8 || currentTime.hours === 12 || currentTime.hours === 18) && currentTime.minutes === 0) {
            if (doMeal) { eat(); }
        }
        updateClock();
        drawTimeLine();
