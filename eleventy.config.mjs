...
export default function (eleventyConfig) {
  ...
  // csv is here for the Data Lab datasets, docx for its write-up template:
  // without them those files are silently left out of _site/ and every
  // download link on the page 404s.
  eleventyConfig.addPassthroughCopy(
    "src/**/*.{css,js,csv,docx,pdf,png,jpg,jpeg,gif,svg,webp,ico,mp3}",
  );
